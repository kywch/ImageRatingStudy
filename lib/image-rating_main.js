...
function generate_instruction_page(instr_url, num_slides) {
    var instructions_page = {
        ...
        pages: function () {
            ...
            pages.push('<p class = block-text>Clicking the <strong>Next</strong> button will finish the instruction.</p></div>')
            return pages;
        },
        data: {
 ...
 * Practice block
 */
function generate_multi_practice_block(prac_img_src, prac_seq, img_ext, task_prompt) {
    var block_sequence = [];
