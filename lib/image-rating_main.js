...
function generate_pair_seq(prefix) {
    /*
        ...
        Input: 46 images
        Output: 22 image pairs + 2 attention check trials
    */
    var attn_idx = 99;   
    var pair_seed = shuffle(range(1, 46));

    if (prefix == 'prac') {
        // sequence for the practice. prepare 8 trials
        var pair_seed2 = pair_seed.slice(0, 16);
        pair_seed2.reshape(8, 2);
